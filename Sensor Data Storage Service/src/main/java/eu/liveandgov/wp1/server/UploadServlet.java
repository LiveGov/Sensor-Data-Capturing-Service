...
public class UploadServlet extends HttpServlet {
    ...
    static {
        Log.info("Loading Upload Servlet Class " + VERSION);
    ...
    public UploadServlet() {
        super();
        Log.info("Creating Servlet Object " + this);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!isCompressed(req)) {
            ...
            Log.info("Opening GZIP Reader for " + outFile);
    ...
    private int writeStreamToFile(InputStream inputStream, File file) throws IOException {
        ...
        int out = IOUtils.copy(inputStream, outputStream);
        outputStream.close();
